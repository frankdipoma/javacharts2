...
public class Common {
	...
	private static void addGeneratedDateTime(JFreeChart chart, String includeGeneratedDateTime) {
		...
		generatedDateTime.setFont(new Font(font.getFontName(), font.getStyle(), 11));
	...
	private static JFreeChart getPieJFreeChart(Map sessionScope, String chartID) {
		...
		Common.addGeneratedDateTime(chart, includeGeneratedDateTime);
	...
	private static JFreeChart getBALJFreeChart(Map sessionScope, String chartID) {
		...
		String legendPosition = sessionScope.get("legendPosition" + chartID).toString();
		String backgroundColor = sessionScope.get("backgroundColor" + chartID).toString();
		...
		setXYAxisProperties(plot, yAxisTickUnit);
		...
		ciRenderer.setBaseItemLabelFont(new Font(font.getFontName(), font.getStyle(), 10));
	...
	private static JFreeChart getGanttJFreeChart(Map sessionScope, String chartID) {
		...
		gRenderer.setBaseItemLabelFont(new Font(font.getFontName(), font.getStyle(), 9));
	...
	private static JFreeChart getHistogramJFreeChart(Map sessionScope, String chartID) {
		...
		if (displayValues) { // If values are to be displayed on the bars
			...
			xybRenderer.setBaseItemLabelFont(new Font(font.getFontName(), font.getStyle(), 9));
		}
	 ...
	 */
	private static void setXYAxisProperties(Plot plot, Object yAxisTickUnit) {
		Axis xAxis = null;
		Axis yAxis = null;
		...
		xAxis.setTickLabelFont(new Font(font.getFontName(), font.getStyle(), 11));
		font = yAxis.getTickLabelFont();
		yAxis.setTickLabelFont(new Font(font.getFontName(), font.getStyle(), 11));
